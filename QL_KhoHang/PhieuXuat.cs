...
namespace BusinessLogic
{
    public class PhieuXuat
    {
        ...
        public void addTien1(string MaPX)
        {
            string sql = "TienXuat";
            SqlConnection con = new SqlConnection(KetNoiDB.getconnect());
            con.Open();
        ...
        public void addTien2(string MaPX)
        {
            string sql = "TienXuat";
            SqlConnection con = new SqlConnection(KetNoiDB.getconnect());
            con.Open();
        ...
        public DataTable HT_CTPX12(string ngay1, string ngay2)
        {
            string str = "HT_TK_CTPX";
            SqlConnection con = new SqlConnection(KetNoiDB.getconnect());
            DataTable dt = new DataTable();
        ...
        public DataTable HT_CTPX13(string ngay1, string ngay2)
        {
            string str = "HT_TK_CTPX";
            SqlConnection con = new SqlConnection(KetNoiDB.getconnect());
            DataTable dt = new DataTable();
